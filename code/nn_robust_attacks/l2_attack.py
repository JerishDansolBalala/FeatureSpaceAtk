...
BINARY_SEARCH_STEPS = 5  # number of times to adjust the constant with binary search
...
class CarliniL2:
    ...
    def attack_batch(self, imgs, labs):
        ...
        o_bestattack = [imgs[i] for i in range(batch_size)]
        ...
        for outer_step in range(self.BINARY_SEARCH_STEPS):
            ...
            for iteration in range(self.MAX_ITERATIONS):
                ...
                l, l2s, scores, nimg = self.sess.run([self.loss, 
        ...
        return o_bestattack#,o_bestl2,o_bestscore
